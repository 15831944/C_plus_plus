...
// aaa.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CaaaApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CaaaApp::OnAppAbout)
...
CaaaApp::CaaaApp()
{
	...
	SetAppID(_T("aaa.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CaaaApp

CaaaApp theApp;


// инициализация CaaaApp
...
BOOL CaaaApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_aaaTYPE,
...
// CaaaApp настройка методов загрузки и сохранения

void CaaaApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CaaaApp::LoadCustomState()
{
}

void CaaaApp::SaveCustomState()
{
}

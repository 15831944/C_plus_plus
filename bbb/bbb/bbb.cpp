...
// bbb.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CbbbApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CbbbApp::OnAppAbout)
...
CbbbApp::CbbbApp()
{
	...
	SetAppID(_T("bbb.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CbbbApp

CbbbApp theApp;


// инициализация CbbbApp
...
void CbbbApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CbbbApp настройка методов загрузки и сохранения

void CbbbApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CbbbApp::LoadCustomState()
{
}

void CbbbApp::SaveCustomState()
{
}
